...
function buildPrompt(item: NewsletterItem, maxChars: number): string {
  ...
  return [
    ...
    "- If the newsletter references visuals/charts/products and image markers are available, place only the relevant marker on its own line right after the related bullet.",
    "- Do not place markers for logos, wordmarks, avatars, decorative art, social icons, section dividers, or sponsor badges.",
    "- Prefer markers only for charts, screenshots, product UI, diagrams, photos, or other visuals that add information the text does not already provide.",
